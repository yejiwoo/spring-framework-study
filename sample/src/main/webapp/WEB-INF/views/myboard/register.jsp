                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                        	<!-- role: 페이지 탐색을 목적으로 페이지 내의 특정 지점을 묘사한다. 스크린 리더가 이영역으로 쉽게 이동하도록 만들 수 있다. -->
                            <form role="form" action="${contextPath }/myboard/register" method="post">
                            	...
                            	<butoon type="button" data-oper="list" class="btn btn-warning"
                            		onClick="location.href='${contextPath }/myboard/list'">취소</butoon>
                            </form>
                        </div>
                        <!-- /.panel-body -->
                    </div>
