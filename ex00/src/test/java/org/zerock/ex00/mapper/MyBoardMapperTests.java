...
//게시물 등록 테스트 - selectKey 사용않음
	/*
	 * @Test public void testInsertMyBoard() {
	 * 
	 * MyBoardVO myBoard = new MyBoardVO(); myBoard.setBtitle("메퍼 테스트-입력제목");
	 * myBoard.setBcontent("매퍼 테스트-입력내용"); myBoard.setBwriter("test");
	 * 
	 * 
